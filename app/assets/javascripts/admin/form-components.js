var FormComponents = function () {
    ...
    var handleSelect2 = function () {
        ...
        function format(state) {
            ...
            return "<admin class='flag' src='assets/admin/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
        ...
        function movieFormatResult(movie) {
            ...
            if (movie.posters !== undefined && movie.posters.thumbnail !== undefined) {
                markup += "<td valign='top'><admin src='" + movie.posters.thumbnail + "'/></td>";
            }
        ...
        $("#select2_sample6").select2({
            ...
            dropdownCssClass: "bigdrop", // apply admin that makes the dropdown taller
            escapeMarkup: function (m) {
                return m;
