class Admin::CouponsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @admin_coupon.update(admin_coupon_params)
        format.html { redirect_to admin_coupon_url @admin_coupon, notice: 'Coupon was successfully updated.' }
  ...
  private
    ...
    def admin_coupon_params
      params.require(:admin_coupon).permit(:login_id, :type_c, :name, :amount)
    end
end
